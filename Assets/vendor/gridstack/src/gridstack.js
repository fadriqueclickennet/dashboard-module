(function (scope, _) {
    ...
    var GridStack = function (el, opts) {
        ...
        this.container.height((this.grid.get_grid_height()) * (this.opts.cell_height + this.opts.verticalMargin) - this.opts.verticalMargin);
    ...
    GridStack.prototype._update_styles = function (max_height) {
        ...
        if (max_height > this._styles._max) {
            for (var i = this._styles._max; i < max_height; ++i) {
                var css;
                css = '.' + this.opts._class + ' .' + this.opts.item_class + '[data-gs-height="' + (i + 1) + '"] { height: ' + (this.opts.cell_height * (i + 1) + this.opts.verticalMargin * i) + 'px; }';
                this._styles.insertRule(css, i);
                css = '.' + this.opts._class + ' .' + this.opts.item_class + '[data-gs-y="' + (i) + '"] { top: ' + (this.opts.cell_height * i + this.opts.verticalMargin * i) + 'px; }';
                this._styles.insertRule(css, i);
            }
    ...
    GridStack.prototype._prepare_element = function (el) {
        ...
        var on_start_moving = function (event, ui) {
            ...
            cell_height = self.opts.cell_height + self.opts.verticalMargin;
            self.placeholder
